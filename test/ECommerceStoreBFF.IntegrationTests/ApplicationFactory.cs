...
public class ApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        await _productCatalogApiContainer.StartAsync();
    ...
    {
        if (_bffContainer is not null)
        {
            await _bffContainer.DisposeAsync();
        }

        if (_productCatalogApiContainer is not null)
        {
            await _productCatalogApiContainer.DisposeAsync();
        }
